...
if(isset($_REQUEST['submit'])){
 ...
 $mailTo = "contact@itsolutiohub.com";
 $headers = "From: ". $email;
...
<textarea class="flow-control" name="message" placeholder="How can we help you?" style="height:150px;"></textarea>
<br>
<input type="submit" class="btn btn-primary" name="submit" value="send"><br><br>
</form>
    </div> -->
    <!-- submit button must be in block level its a mistake -->