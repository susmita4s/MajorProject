...
<div class="col-sm-5 mt-5 jumbotron "style="background-color:#d3d0d4">
  <!-- Main Content area Start Last -->
  <form action="" method="POST">
    <h5 class="text-center mt-3">Assign Work Order Request</h5>
    ...
    <div class="float-right" >
      <button type="submit" class="btn btn-success mx-2 mt-4 mb-2" name="assign">Assign</button>
      <button type="reset" class="btn btn-secondary mt-4 mb-2">Reset</button>
    </div>
