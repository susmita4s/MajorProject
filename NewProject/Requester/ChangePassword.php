...
<div class="col-sm-6 mt-5 mx-5">
  <div class="row">
    <div class="col-sm-12">
      <form class="mt-5 mx-6" method="POST">
        ...
        <button type="submit" class="btn btn-danger mr-4 mt-4 mb-4" name="passupdate">Update</button>
        <button type="reset" class="btn btn-secondary mt-4 mb-4">Reset</button>
